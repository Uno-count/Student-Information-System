    ...
    <body>
        <header>
            ...
            <nav>
                <ul class="nav_links">
                    ...
                    <li><a class="activeForm" href="./Student_account.php">ACCOUNT</a></li>
        ...
        <main>
            <section class="content-enroll">
                ...
                <div id="Section">
                    <div class="enrollment-content">Course: BSCS 3C</div>
                </div>
                <div id="Course">
                    <div class="enrollment-content">Year: BSCS 3C</div>
                </div>
                <div id="Year">
